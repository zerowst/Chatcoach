...
###-------------------------------------------extracting keywords---------------------------------------------------
    ...
    end_key = time.time()
    print("Extracting keywords: ", end_key - start_key)
...
###---------------------------------------------database input--------------------------------------------------
    ...
    answer_llama = ""
    end_load = time.time()
    print("Loading time: ", end_load - start_load)

    ###-------------------------------------------------retrieve procedures-------------------------------------------
    start_retri = time.time()
    ...
    end_retri = time.time()
    print("Retrieving time: ", end_retri - start_retri)
    ...
    for i, chunk in enumerate(divided_text):
        ...
        print("Prompt {} time: {}".format(i, end_prompt - start_prompt))
