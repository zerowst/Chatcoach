...
def main():
    ...
    if training_args.do_eval:
        ...
        def compute_metrics(eval_pred):
            ...
            # Depending on the task you might need to change what's considered a prediction and what's considered a label
            decoded_labels = tokenizer.batch_decode(labels, skip_special_tokens=True)
            # Rouge expects a list of hypotheses and references
            ...
            return {'roug4_precision': result_rouge4.precision, 'rouge4_recall': result_rouge4.recall, 'rouge4_fmeasure': result_rouge4.fmeasure}
